...
function validateProductPrice ()
{
    ...
    else
    {
        ...
        document.getElementById( "ProductPriceAlert").innerHTML= "*Product price from [1-5] digit";
        document.getElementById("mainButton").setAttribute('disabled','disabled'); 
    }
...
function validateProductCategory ()
{
    ...
    {
        document.getElementById( "ProductCategoryAlert").innerHTML= "*Category must be one word or more from 20 letter";
        document.getElementById("mainButton").setAttribute('disabled','disabled'); 
    }
}
