...
$("#demo").click(function () {
    ...
    a5 = $('a').eq(5).outerHeight(true)
        ...
        $("#sidebar").animate({ left: "0px" }, 500, () => {
            $('a').eq(0).animate({ top: `0px` , left:`15px`,marginTop:`10px` }, 500 , ()=>{
                $('a').eq(1).animate({ top: `${a1}`, left:`15px`,marginTop:`10px` }, 500 , ()=>{
                    $('a').eq(2).animate({ top: `${a1+a2}`, left:`15px` , marginTop:`10px` }, 500 ,()=>{
                        $('a').eq(3).animate({ top: `${a1+a2+a3}`, left:`15px`,marginTop:`10px` }, 500, ()=>{
                            $('a').eq(4).animate({ top: `${a1+a2+a3+a4}`, left:`15px`,marginTop:`10px` }, 500 ,()=>{
                                $('a').eq(5).animate({ top: `${a1+a2+a3+a4+a5}`, left:`15px`,marginTop:`10px` }, 500,()=>{
...
function displayMovies(x) {
    ...
    for (let i = 0; i <x.length  ; i++) {
        ...
        <div  class="  my-3 text-center position-relative  d-flex justify-content-center align-items-center catch">
            ...
            <h5 class="colorBlack p-2 ">${x[i].overview}</h5>
            <h4 class="colorBlack mt-2 " >Rate:${x[i].vote_average}</h4>
            <h4 class="colorBlack mt-1 " >${x[i].release_date}</h4>
